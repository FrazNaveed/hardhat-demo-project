...
// File: aetheriaethrxtoken.sol

pragma solidity ^0.8.0;

contract Aetheria is ERC20, ERC20Burnable, Pausable, Ownable {
    constructor() ERC20("Aetheria", "ETHRX") {
        _mint(msg.sender, 9650000000 * 10 ** decimals());
    }
